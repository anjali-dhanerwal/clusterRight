...
Perform a comprehensive health check of Aurora PostgreSQL cluster `auroradataapi`, delivering actionable insights aligned with the **AWS Well-Architected Framework** (all five pillars). The analysis must cover database performance, cost optimization (including Reserved Instances, Database Savings Plans, and commitment strategy comparison), security, reliability, operational excellence, and PostgreSQL version lifecycle (end-of-life status and extended support charges). 

Use official AWS documentation as the authoritative source for version lifecycle, pricing, and best practices.

---

## Cluster Details

- **Cluster Identifier:** `auroradataapi`
- **Engine:** Aurora PostgreSQL
- **Output Directory:** `/Users/anjaliad`
...
- **Table of Contents:** Auto-generated with navigation
...
The overall health score (out of 100) is a weighted qualitative assessment across the five Well-Architected pillars. For each pillar:
